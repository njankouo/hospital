                    ...
                    <div class="flex-1">
                        ...
                        <div class="card">
                            <div class="card-title">
                                <div>
                                    <form action="{{ route('clear.service') }}" method="POST">
                                        @csrf
                                        <button class="btn btn-primary my-4" style="float: right;margin-right:15px;">vider
                                            le tableau</button>
                                    </form>
                                </div>
                                <a class="btn btn-primary my-4 text-light mx-2" href="{{ route('nouvel.facture') }}">
                                ...
                                <table class="w-full text-sm lg:text-base table table-bordered" cellspacing="0">
                                    <thead>
                                        <tr class="h-12 uppercase">
                                            ...
                                            <th class="hidden text-right md:table-cell"> service</th>
                                            <th class="hidden text-right md:table-cell"> poste</th>
                                            <th class="hidden text-right md:table-cell"> beneficiaire</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cartItems as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden text-right md:table-cell">
                                                    <form action="{{ route('return.service') }}" method="POST">
                                                        @csrf
                        ...
                        <a class="btn btn-warning my-4 text-light mx-2" href="{{ route('service.anexe') }}">
                            <i class="fa fa-back"></i>retour au cmcu agora
                        </a>
                        <a class="btn btn-secondary my-4 text-light mx-2" href="{{ route('show.service') }}">
                            <i class="fa fa-back"></i>retour a la liste des services
                        </a>
