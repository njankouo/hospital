...
@section('contenu')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-title my-4 mx-3">
                    <h3 style="font-family:forte">liste des Services</h3>
                        ...
                        <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
                            <thead class="text-center">
                                <tr>
                                    ...
                                    <th style="width: 20%">nom service</th>
                            ...
                            <tbody class="text-center">
                                @foreach ($service as $services)
                                    <tr>
                                        ...
                                        @else --}}
                                        <td>
                                            <form action="{{ route('service.delete', $services->id) }}" method="POST">
                                                @csrf
    ...
    <script type="text/javascript">
        $('.show_confirm').click(function(event) {
            ...
            swal({
                    title: `voulez-vous retirer  ce service`,
                    text: "De la liste des services?",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
