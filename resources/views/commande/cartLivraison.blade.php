        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-title">
                    <a href="{{ route('livraison.group') }}" class="btn btn-primary text-light my-4 mx-4"
                        style="float: right;">
                        <i class="fa fa-print"></i>
                        generer bon de livraison
                    </a>
                    <form action="{{ route('clear.livraison') }}" method="POST">
                        @csrf
                    ...
                    <table id="cart" class="table table-bordered table-condensed">
                        ...
                        <tr>
                            <td colspan="7" class="text-right">
                                <a href="{{ route('livraison') }}" class="btn btn-warning"><i
