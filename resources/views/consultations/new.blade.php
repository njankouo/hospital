                    ...
                    <div>
                                ...
                                <div class="note-dropzone">
                                    ...
                                    <div class="note-toolbar panel-heading" role="toolbar" style="position: relative; top: 0px; width: 100%;">
                                        <div class="note-btn-group btn-group note-style">
                                            <div class="note-btn-group btn-group">
                                                <button type="button" class="note-btn btn btn-default btn-sm dropdown-toggle" role="button" tabindex="-1" data-toggle="dropdown" title="" aria-label="Style" data-original-title="Style">
                                    ...
                                    <div class="note-btn-group btn-group note-font">
                                        <button type="button" class="note-btn btn btn-default btn-sm note-btn-bold" role="button" tabindex="-1" title="" aria-label="Bold (CTRL+B)" data-original-title="Bold (CTRL+B)">
                                            ...
                                            <button type="button" class="note-btn btn btn-default btn-sm note-btn-underline" role="button" tabindex="-1" title="" aria-label="Underline (CTRL+U)" data-original-title="Underline (CTRL+U)">
                                                <i class="note-icon-underline"></i>
                                            </button>
                                            <button type="button" class="note-btn btn btn-default btn-sm" role="button" tabindex="-1" title="" aria-label="Remove Font Style (CTRL+\)" data-original-title="Remove Font Style (CTRL+\)">
                                                <i class="note-icon-eraser"></i>
                                            </button>
                                        </div>
                                        <div class="note-btn-group btn-group note-fontname">
                                            <div class="note-btn-group btn-group">
                                                <button type="button" class="note-btn btn btn-default btn-sm dropdown-toggle" role="button" tabindex="-1" data-toggle="dropdown" title="" aria-label="Font Family" data-original-title="Font Family">
                                                    <span class="note-current-fontname" style="font-family: sans-serif;">sans-serif</span>
                                                     <span class="note-icon-caret"></span>
                                                    </button>
                        ...
                        <section>
                            <div class="form-group">
                                ...
                                <textarea name="antecedant" id="" cols="15" rows="10" class="form-control"></textarea>
                                @error('antecedant')
                                <span  class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="antecedant_churirgicaux" id="" cols="15" rows="10" class="form-control"></textarea>
                                @error('antecedant')
                                <span  class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="antecedant_familliale" id="" cols="15" rows="10" class="form-control"></textarea>
                                @error('antecedant')
                                <span  class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                <label>Autres Antecedents</label>

                                <textarea name="autre_antecedant" id="" cols="20" rows="10" class="form-control"></textarea>
                                @error('antecedant')
                                <span  class="text-danger">{{ $message }}</span>
                        ...
                        <h4>Validation De La Consultation</h4>
                        <section>


                                <div class="col-10 col-sm-12 mb-0">
                                <label for="resultat">Resultat Examen Clinique</label>
                                <textarea name="resultat" id="" cols="30" rows="10" class="form-control"></textarea>
                            </div>
                                    <hr>
                                <h5 style="color: red">les informations liées a la consultation seront automatiquement enregistrées apres la validation des champs normalement remplis</h5>
                        </section>

                    </div>
                    <button type="submit" class="btn btn-primary" style="float: right;margin:2%">Valider Consultation</button>
