  ...
  @section('contenu')
      {{-- @if (Session::has('success'))
          <script>
              swal('utilisateur cree avec success', "{ !!Session::get('success')!! }", "success", {
                  button: "OK",
              })
          </script>
      @endif --}}
                      ...
                      <form action="{{ route('users.create') }}" method="POST">
                          ...
                          <div class="row">
                              ...
                              <div class="col-6">
                                  ...
                                  <select class=" @error('pieceIdentite') is-invalid @enderror" id=""
                                      name="pieceIdentite">
                                      <option value=""></option>
                          ...
                          <div class="row">
                              <div class="col-6">
                                  ...
                                  <select name="sexe" class=" @error('sexe') is-invalid @enderror" id="">
                                      <option value=""></option>
